...
Color kYellowColor = const Color(0xffFFD400);
Color kRedColor = const Color(0xffEB70A5);
Color kBackgroundColor = const Color(0xff0E162A);
...
Color kButtonColor = const Color(0xff5E56FF);
...
Widget loadingIndicator = SpinKitFadingCircle(size: 45, color: kPrimaryColor);
